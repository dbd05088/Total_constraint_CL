...
# CIL CONFIG
NOTE="ours_total_sigma10_iter0.75" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="ours"
...
do
    CUDA_VISIBLE_DEVICES=3 nohup python main_new.py --mode $MODE \

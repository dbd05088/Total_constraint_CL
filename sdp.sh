...
# CIL CONFIG
NOTE="sdp_total_sigma10_iter0.75" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="sdp"
